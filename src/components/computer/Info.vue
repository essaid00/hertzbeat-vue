      ...
      <div class="row q-py-sm">
        <div class="col col-md col-sm">
          <q-btn-group v-if="isSuperUser">
            ...
            <q-btn
color="primary" icon="mdi-content-save-edit" :loading="loading" :disabled="loading"
              @click="updateName">
              <q-tooltip>
          ...
          <div v-else class="text-h5">
            {{ name }}
            <q-btn
flat icon="mdi-content-copy" size="sm" color="primary"
      ...
      <div class="row q-py-sm">
        <div class="col-6 col-md col-sm">
          ...
          <q-btn
v-if="fqdn" flat icon="mdi-content-copy" size="sm" color="primary"
            @click.stop="contentToClipboard(fqdn)"><q-tooltip>{{ $gettext('Copy') }}</q-tooltip></q-btn>
        </div>

        <div class="col-6 col-md col-sm">
          <DateView
:value="createdAt" icon="mdi-calendar-plus"
      ...
      <div class="row q-py-sm">
        <div class="col-6 col-md col-sm">
          <MigasLink
model="platforms" :pk="project.platform.id" :value="project.platform.name"
      ...
      <div class="row q-py-sm">
        <div class="col-6 col-md col-sm">
          ...
          <q-btn
v-if="ipAddress" flat icon="mdi-content-copy" size="sm" color="primary"
        ...
        <div class="col-6 col-md col-sm">
          ...
          <q-btn
v-if="forwardedIpAddress" flat icon="mdi-content-copy" size="sm" color="primary"
    ...
    <q-card-actions class="justify-between q-px-md">
      <q-btn
:icon="appIcon('events')" color="info" text-color="black" no-caps :to="{
            name: 'computer-events',
            params: { id: cid },
          }" :label="$gettext('Events')" />

      <q-btn
:icon="appIcon('simulate')" color="info" text-color="black" no-caps :to="{
            name: 'computer-simulate',
            params: { id: cid },
          }" :label="$gettext('Simulate synchronization')" />

      <q-btn
icon="mdi-card-account-details-outline" color="info" text-color="black" no-caps :to="{
            name: 'computer-label',
            params: { id: cid },
