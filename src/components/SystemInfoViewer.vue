<template>
  <div class="q-pa-md system-info-container">
    <q-card class="my-card">
      <q-card-section>
        ...
        <div class="text-caption">
          ID: {{ systemInfo.id }} | Delegation: {{ systemInfo.codeDelegation }}
        </div>
      </q-card-section>
                    ...
                    <q-item>
                      <q-item-section>
                        <q-item-label caption
                          >Available Processors</q-item-label
                        >
                        <q-item-label>{{
            ...
            <q-card-section>
              <div class="row q-col-gutter-md">
                <div class="col-12">
                  ...
                  <q-list
                    v-if="systemInfo.sauvgarde.found"
                    dense
                    class="q-mt-sm"
                  >
                    <q-item>
                ...
                <div class="col-12 col-md-6">
                  <q-list dense>
                    <q-item>
                      <q-item-section>
                        <q-item-label caption
                          >Non-Heap Memory Usage</q-item-label
                        >
                        <q-item-label>{{
