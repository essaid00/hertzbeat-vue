            ...
            <template #header>
              <q-item-section>
                <div class="text-h5 q-py-sm">
                  <translate :translate-params="{ number: lastHours }">History of events in the last %{ number } hours
                  </translate>
                </div>
              </q-item-section>
            </template>
    ...
    <div class="row">
      <div class="col-12">
        ...
        <StackedBarChart v-show="!loadingMonthlySyncs" id="monthly-syncs" :title="monthlySyncsTitle"
          ...
          <template #selector>
            <q-card-section class="row justify-center q-py-none">
              <MonthInput v-model="begin" class="q-ma-sm" :label="$gettext('Initial Month')" />
...
export default defineComponent({
  ...
  components: { Breadcrumbs, Header, StackedBarChart, MonthInput },
